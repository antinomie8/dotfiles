...
ListView {
	...
	add: Transition {
		animations: animateAppearance ? [Appearance?.animation.elementMove.numberAnimation.createObject(this, {
	...
	displaced: Transition {
		animations: root.animateMovement ? [Appearance?.animation.elementMove.numberAnimation.createObject(this, {
				property: "y"
			}), Appearance?.animation.elementMove.numberAnimation.createObject(this, {
