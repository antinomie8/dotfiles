...
Scope {
    ...
    IpcHandler {
        ...
        function toggleForWorkspace(): void {
            let id = Hyprland.focusedWorkspace.id;
            if (GlobalStates.workspacesWithBarClosed[id]) {
    ...
    GlobalShortcut {
        name: "barToggleForWorkspace"
        description: "Toggles the bar for the current workspace"
    ...
    GlobalShortcut {
        name: "barOpenForWorkspace"
        description: "Opens the bar for the current workspace"
    ...
    GlobalShortcut {
        name: "barCloseForWorkspace"
        description: "Closes the bar for the current workspace"
