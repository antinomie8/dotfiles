...
() {
	...
	typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
		# =========================[ Line #1 ]=========================
		neovim_shell            # adds vim icon if $NVIM is set
	...
	if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
		...
		typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND="#363646"
	...
	typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND="#957fb8"
	...
	typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND="#7fb4ca"
...
# colors
	...
	typeset -g POWERLEVEL9K_VIM_SHELL_FOREGROUND="#98bb6c"
	# Custom icon.
	...
	typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND="#dca561"
	# Context color in SSH without privileges.
	typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND="#dca561"
	# Default context color (no privileges, no SSH).
	typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND="#dca561"

	# Context format when running with privileges: bold user@hostname.
	typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%F{#dca561\}%F{#1f1f28\}%K{#dca561\}%F{#dca561\}%K{#1f1f28\}'
	...
	function prompt_neovim_shell() {
		[[ -n $NVIM ]] && p10k segment -f "#98BB6C" -i " "
	}
