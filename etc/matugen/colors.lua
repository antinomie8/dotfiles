hl.config({
	...
	group = {
		groupbar = {
			text_color = "rgba({{colors.inverse_primary.default.hex_stripped}}AA)",
			col = {
				active = "rgba({{colors.inverse_primary.default.hex_stripped}}EE)",
				inactive = "rgba({{colors.inverse_primary.default.hex_stripped}}66)",
			},
		},
	},
})
